  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-[100vh] w-full">
        <div className="flex flex-col justify-center items-center h-full w-1/4 bg-gradient-to-r from-cyan-500 to-blue-500">
        ...
        <div className="flex flex-col justify-center items-stretch h-full w-3/4 bg-white">
